           ...
           Row(
              children: <Widget>[
                Expanded(
                  ...
                  child: Container(
                    ...
                    color: Color.fromRGBO(255,60,65, 1),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    // padding: EdgeInsets.all(30.0),
                    color: Color.fromRGBO(255,60,65, 1),
                    child: Center(child: Text('\$13725', style:TextStyle(color: Colors.white ))),
                    alignment: Alignment.centerLeft,
                  ),
                ),
              ],
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    // padding: EdgeInsets.all(30.0),
                    color: Color.fromRGBO(255,60,65, 1),
                    child: Center(child: Text('\$13075', style:TextStyle(color: Colors.white ))),
                    alignment: Alignment.centerLeft,
                  ),
                ),
              ],
            ...
            Row(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    // padding: EdgeInsets.all(30.0),
                    color: Color.fromRGBO(255,60,65, 1),
                    child: Center(child: Text('\$650', style:TextStyle(color: Colors.white ))),
                    alignment: Alignment.centerLeft,
                  ),
                ),
              ],
             ...
             Container(
                ...
                child: Image.asset('assets/investment_distribution.png'),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: new Container(
                    ...
                    //here
                    child: Center(child: Text('What stocks you are holding?',style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 1.2))),
                  ),
                  ),
                ),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: new Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5, 5, 5, 5),
                    padding: EdgeInsets.all(15.0),      
                    child: Text('2388',style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.8)),
                  ),
                  ),
                ),
                Expanded(
                  ...
                  child: new Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5, 5, 5, 5),
                    padding: EdgeInsets.all(15.0),      
                    child: Text('BOC HONG KONG',style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.7)),
                  ),
                  ),
                ),
                Expanded(
                  ...
                  child: new Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5, 5, 5, 5),
                    padding: EdgeInsets.all(15.0),      
                    child: Text('500',style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.7)),
                  ),
                  ),
                ),
                Expanded(
                  ...
                  child: new Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5, 5, 5, 5),
                    padding: EdgeInsets.all(15.0),      
                    child: Text('27.45',style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.7)),
                  ),
                  ),
                ),
                Expanded(
                  ...
                  child: new Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5, 5, 5, 5),
                    padding: EdgeInsets.all(15.0),      
                    child: Text('13075',style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.7)),
                  ),
                  ),
                ),
                Expanded(
                  ...
                  child: new Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5, 5, 5, 5),
                    padding: EdgeInsets.all(15.0),      
                    child: Text('650',style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.7)),
                  ),
                  ),
                ),
              ],
