    ...
    return FlutterLogin(
      ...
      titleTag: Constants.titleTag,
       ...
       theme: LoginTheme(
         ...
         accentColor: Color.fromRGBO(159, 42, 51,1),
         ...
         inputTheme: InputDecorationTheme(
           ...
           enabledBorder: UnderlineInputBorder(
             borderSide: BorderSide(color: Color.fromRGBO(159, 42, 51,1), width: 4),
             borderRadius: inputBorder,
           ),
           focusedBorder: UnderlineInputBorder(
             borderSide: BorderSide(color: Color.fromRGBO(255, 42, 51,1), width: 5),
             borderRadius: inputBorder,
           ),
